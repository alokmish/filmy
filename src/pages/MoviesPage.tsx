...
const MoviesPage = () => {
  ...
  const fetchMovies = async () => {
    ...
    setLoading(true);
    const { data } = await axios.get(
      `https://api.themoviedb.org/3/discover/movie?api_key=38ec201fb1fa7cdffa88b74569f61507&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_genres=${genreListForURL}`
    );
